        ...
        {rows.map((row, idx) => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-start gap-8 max-w-xl">
              <h3 className="text-3xl md:text-5xl font-heading italic text-white leading-tight">
                {row.title}
              </h3>
              <p className="text-white/60 font-body font-light text-base md:text-lg leading-relaxed">
                {row.body}
              </p>
              <button className="liquid-glass-strong rounded-full px-8 py-3 text-white text-sm font-medium">
                {row.cta}
              </button>
            </div>
